...
raw_url = "https://raw.githubusercontent.com/13Junio-Innovating/supermarket-sales-dashboard/main/supermarket_sales.csv"
df = None
try:
    df = pd.read_csv(raw_url, sep=";", decimal=",", index_col=0)
except Exception:
    if data_path.exists():
        try:
